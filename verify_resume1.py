...
class Crawler:
	def __init__(self):
		self.driver = webdriver.Chrome()  # assuming Chrome, can be changed to other browsers
...
# Execute the JavaScript code
	...
	def crawl(self):
		...
		win_scroll_x = driver.execute_script("return window.scrollX;")
		win_scroll_y = driver.execute_script("return window.scrollY;")
		win_upper_bound = driver.execute_script("return window.pageYOffset;")
		win_left_bound = driver.execute_script("return window.pageXOffset;")
		win_width = driver.execute_script("return window.screen.width;")
		win_height = driver.execute_script("return window.screen.height;")
  
  
		win_right_bound = win_left_bound + win_width
		win_lower_bound = win_upper_bound + win_height
		document_offset_height = driver.execute_script("return document.body.offsetHeight;")
...
# lost hope at this point because selenium's DOM capture isn't as detailed as playwright's
