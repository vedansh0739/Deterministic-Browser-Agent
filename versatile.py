...
achieving your objective. And then interact with that page to get closer to achieving your objective. Keep interacting until you achieve your objective.

If you find yourself on Google and there are no search results displayed yet, you should probably issue a command 
like "TYPESUBMIT 7 "search query"", where 7 is the id of the <input> or <textarea> where the search query has to be entered.
